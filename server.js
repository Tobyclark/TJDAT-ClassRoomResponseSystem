...
classinfo.forEach(element => {
    ...
    answer = parseInt(req.body[element.question]);
...
if(user.isTeacher === false)
{
  ...
  masterlist = master.class;
  classID = req.body.classID;
  res.render('student-class.ejs', {questions: masterlist[classID], classID: classID, id:req.body.id});
} else {

  classID = req.body.classID;
  res.render('teacher-class.ejs', {classID: classID, id:req.body.id});
}
});
